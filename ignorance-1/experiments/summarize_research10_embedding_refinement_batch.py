        ...
        runs.append(
            {
                ...
                "alignment_prediction_weight": float(p4.get("alignment_prediction_weight", 0.75)),
                "alignment_embedding_weight": float(p4.get("alignment_embedding_weight", 1.0)),
                "alignment_mse_weight": float(p4.get("alignment_mse_weight", 0.1)),
            }
        )
    return {
        "family": family,
