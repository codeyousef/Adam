        ...
        runs.append(
            {
                ...
                "reference_size": int(p4.get("reference_size", 0) or 0),
                "step_scale_power": float(p4.get("step_scale_power", 0.0)),
                "max_step_multiplier": float(p4.get("max_step_multiplier", 1.0)),
                "classifier_weight": float(p4.get("classifier_weight", 0.25)),
                "ignorance_ood_weight": float(p4.get("ignorance_ood_weight", 0.2)),
                "ignorance_pred_weight": float(p4.get("ignorance_pred_weight", 0.2)),
