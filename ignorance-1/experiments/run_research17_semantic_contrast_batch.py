...
def build_families() -> list[autorun.Experiment]:
    ...
    return [
        autorun.Experiment(
            ...
            {
                "profile": "robustness",
                "phase4": {**base, "phase4_dataset": "benchmark_v1", "phase4_joint_training": False},
            },
        ),
        autorun.Experiment(
            ...
            {
                "profile": "robustness",
                "phase4": {**base, "phase4_dataset": "semantic_contrast_v1", "phase4_joint_training": False},
            },
        ),
        autorun.Experiment(
            ...
            {
                "profile": "robustness",
                "phase4": {**base, "phase4_dataset": "semantic_contrast_v1", "phase4_joint_training": True},
            },
        ),
    ]
...
def main() -> int:
    ...
    if not queue:
        print("No pending research17 semantic contrast batch experiments.")
        return 0
    ...
    with autorun.AUTORUN_LOG.open("a") as log_handle:
        log_handle.write(f"start {time.strftime('%Y-%m-%d %H:%M:%S')} strategy=research17_semantic_contrast_batch\n")
        for exp in queue:
