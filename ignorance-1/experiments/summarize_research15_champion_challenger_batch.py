        ...
        runs.append(
            {
                ...
                "champion_challenger_weight": float(p4.get("champion_challenger_weight", 0.0)),
                "champion_challenger_margin": float(p4.get("champion_challenger_margin", 0.05)),
                "champion_challenger_temperature": float(p4.get("champion_challenger_temperature", 0.1)),
                "champion_challenger_start_fraction": float(p4.get("champion_challenger_start_fraction", 0.0)),
                "champion_challenger_ramp_fraction": float(p4.get("champion_challenger_ramp_fraction", 0.0)),
                "champion_challenger_effective_weight": float(p4.get("champion_challenger_effective_weight", 0.0)),
                "champion_challenger_selected_size": p4.get("champion_challenger_selected_size"),
                "champion_challenger_loss": float(p4.get("champion_challenger_loss", 0.0)),
            }
        )
    return {
        "family": family,
        ...
        "mean_champion_challenger_loss": mean([run["champion_challenger_loss"] for run in runs]),
